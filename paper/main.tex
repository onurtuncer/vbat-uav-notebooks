...
\author{%
  ...
  \and Ahmet G\"une\c{s}$^{1}$
  \and \c{C}a\u{g}lar \"U\c{c}ler$^{2}$\\[1ex]
  \small $^{1}$Istanbul Technical University, Istanbul, T\"urkiye\\
  \small $^{2}$\"Ozye\u{g}in University, Istanbul, T\"urkiye%
}
\date{}
